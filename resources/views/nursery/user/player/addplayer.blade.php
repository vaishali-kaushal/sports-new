                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h4>Personal Details</h4>
                                <form class="row" method="post" id="playerForm"  enctype="multipart/form-data" action="{{ route('save.playerDetail')}}">
                                @csrf
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label class="form-label">Player Level</label><span class='star'>*</span>
                                        <select class="form-control" name="player_level" id="player_level">
                                            <option value="">-----Select-----</option>
