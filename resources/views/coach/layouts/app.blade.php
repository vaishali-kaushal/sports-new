...
<?php 
 ...
 $profile = App\Models\Coach::nurseryDetailCoach();

?>

                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">Coach Name : <b> {{ Auth::user()->name }} </b> </a>
                  
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">Nursery Name : <b> {{ $profile->name_of_nursery }} </b> </a>

                  
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">Game : <b> {{ $profile->game->name }} </b> </a>
 
                  
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">District : <b> {{ $profile->district->name }}</b></a>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('coach/player/add') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Player</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('coach/player/list') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Player List</p>
                                    </a>
                                </li>
