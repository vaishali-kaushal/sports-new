            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item {{ Request::is('admin/nursery*') ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.pendingList','recommended') }}" class="nav-link {{ Request::is('admin/nursery/list/recommended') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Recommended by DSO</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.pendingList','notrecommended') }}" class="nav-link {{ Request::is('admin/nursery/list/notrecommended') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Not Recommended</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/nursery/list/notr') }}" class="nav-link {{ Request::is('admin/nursery/list/notr*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Not Recommended</p>
                                    </a>
                                </li> -->
                        ...
                        {{--  ========================================  --}}
                        <li class="nav-item {{ Request::is('admin/dso*') ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/dso') }}" class="nav-link  {{ Request::is('admin/dso') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>DSO List</p>
                                    </a>
                                </li>
